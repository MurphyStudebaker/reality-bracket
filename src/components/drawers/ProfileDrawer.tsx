                    ...
                    <TabsContent value="login" className="mt-8">
                      ...
                      <div className="space-y-3 mb-6">
                        <Button
                          ...
                          className="w-full h-12 rounded-xl font-medium bg-white hover:bg-gray-100 text-gray-900 border border-gray-300"
                        ...
                        <Button
                          ...
                          className="w-full h-12 rounded-xl font-medium bg-black hover:bg-gray-900 text-white border border-gray-800"
                          disabled={auth.isLoading}
                        >
